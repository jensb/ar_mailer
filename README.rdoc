= reason for fork
The purpose of this fork's fork is to allow scheduling emails for future delivery (e.g. "send in one week").
The exact sending time can vary depending on the run frequency of ar_sendmail (currently 5 minutes).
